  ...
  <div class="page-heading header-text">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <h3>{{ $product->title }}</h3>
          <span class="breadcrumb"><a href="/">Home</a>  >  <a href="{{ url()->previous() }}">Shop</a>  >  {{ $product->title }}</span>
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="row">
        <div class="col-lg-6">
          <div class="left-image">
            <img src="{{ asset('assets/images/single-game.jpg') }}" alt="">
          </div>
        </div>
        <div class="col-lg-6 align-self-center">
          ...
          <ul>
            ...
            <li><span>Genre:</span> <a href="#">{{ $product->category->name }}</a>, <a href="#">Team</a>, <a href="#">Single</a></li>
